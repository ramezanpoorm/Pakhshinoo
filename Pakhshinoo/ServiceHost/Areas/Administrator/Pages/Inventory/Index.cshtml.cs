...
namespace ServiceHost.Areas.Administrator.Pages.Inventory
{
    public class IndexModel : PageModel
    {
        ...
        {
            var inventoryDiscount = _inventoryApplication.GetDetails(Id);
            inventoryDiscount.Products = _productApplication.GetProducts();
            return Partial("Edit", inventoryDiscount);
        }
